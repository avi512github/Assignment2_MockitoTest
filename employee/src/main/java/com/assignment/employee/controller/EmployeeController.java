...
public class EmployeeController {
	  ...
	  @DeleteMapping("/hireDateLessThan/givenDate/{givenDate}") 
	  public HttpStatus deleteEmployeeFromSalaryTblHavingHireDateBeforeGivenDate(@PathVariable("givenDate") String givenDate) throws RecordNotFoundException {
		  	
		  employeeService.deleteEmployeeFromSalaryTblHavingHireDateBeforeGivenDate(givenDate); 
